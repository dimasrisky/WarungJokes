...
const App = () => {
  ...
  useEffect(() => getJoke(), [])
  return (
    <main className='w-[100vw] h-[100vh] bg-[#E9B824] flex justify-center items-center relative'>
      <div className='absolute top-[3rem] sm:top-[2rem] text-center font-bold font-pixely flex flex-col mb-[2rem]'>
        <span className='text-[2.4rem] sm:text-[2.6rem] md:text-[2.8rem] lg:text-[3rem] xl:text-[3.2rem] mb-[-0.4rem]'>Selamat Datang</span>
        <span className='text-[1.4rem]'>Di WarungJokes 👋</span>
      </div>
      <p className="absolute font-inter top-[9rem] text-center text-xs italic max-w-[25rem]">Random Jokes Generator yang isinya Jokes-Jokes Receh yang biasa dipake bapak bapak, selamat mencoba 👍</p>
